...
1. **Прочитай** соответствующую документацию в `docs/` (если она существует)
2. **Изучи** `feature-map.md` для понимания текущего состояния (если файл существует)
3. **Сверься** с README.md для общего контекста проекта

### При изменении функционала

1. **Обнови** соответствующие разделы документации (или создавай её, если её нет)
2. **Отметь** изменения в `feature-map.md` (статус реализации, новые функции) - создай файл, если его нет
